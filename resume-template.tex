...
\newcommand{\jobtitle}[4]{
    \textbf{\color{textdark}#1} \hfill \textcolor{textgray}{\small #2} \\
    \textcolor{textgray}{\small #3} \hfill \textcolor{textgray}{\small #4}
    \vspace{0.2em}
}

\newcommand{\project}[3]{
    \textbf{\color{textdark}#1} \hfill \href{#3}{\textcolor{accentblue}{\small \faLink}}\\
    \textcolor{textgray}{\small #2}
    \vspace{0.2em}
}

\newcommand{\skillcategory}[5]{
    \textbf{\color{textdark}#1} \hfill \textcolor{textgray}{\small #4} \\
    \textcolor{textgray}{\small #2} \hfill \textcolor{textgray}{\small #3} \\
    \vspace{0.1em}
